...
### F8 F8 F8 00
52FD70 - 53E3FF пак кнопок, артефактов нет, но.. без фона радиокнопок и судя по всему слайдеры под цветовым кругом без изменений.
###
...
#20 40 80 - цвет кала, который надо смыть

### B0 B0 B0 00 - фикс артефактов фона канваса (осветление экрана при приближении + полосы по сторонам холста при разных приближениях)
sections .text, где я нашел 21 последовательность с B0 B0 B0 00. Думаю можно создать просто массив с диапазоном всей секции текста, ибо по сути там больше то и нечего менять. может ещё пригодиться для чего.
###


### FF DB DB - фон выделенных объектов (слои, кисти, вкладки и тд) idle
section .srclibs
###

### FF D4 D4 - фон выделенных объектов при наведении, если активны
section .srclibs
### 

### FF F6 F6 - фон объектов при наведении
section .srclibs
### 

### FF 80 80 - обводка выделенных объектов
section .srclibs
### 

### FF C2 C2 - внутренняя обводка выделенных объектов при наведении
section .srclibs
###

### FF CF CF - внутренняя обводка выделенных объектов idle
section .srclibs
###

### FF D4 EC - фон объектов при нажатии
???
###

### FF 66 B5 - обводка объектов при нажатии
???
###

### FF BF E4 - внутренняя обводка объектов при нажатии
???
###

### FF A6 A6 / FF 8E 8E / F9 DF DF / F9 E4 E4 - артефакты обводки объектов
section .srclibs
###