...
section / .srclibs - E4 E4 E4 00 часть обводки некоторых кнопок.
...
section / .srclibs - F8 F8 F8 00 замена этого поменяла цвета "квадратов у радиокнопок" + заливку у всех других маленьких кнопок
